...
public class PageRankTemplate {
	...
	public static class MapperClass extends
		...
		// get the parameters set by the main function (see the main function.
		// we call "conf.set")
		//
		...
		public void map(Object key, Text value, Context context)
			...
			outdegree = arr.length - 1; // how many links in this page

			for (int i = 1; i < arr.length; i++) {
				emitKey.set(Integer.parseInt(arr[i]));
				emitVal.set(pagerank[myid] / outdegree);
	...
	public static class ReducerClass extends
		...
		public void reduce(IntWritable key, Iterable<DoubleWritable> values,
			...
			pagerank_val = (damping * sum) + (1 - damping) * (1 / npoint);
	...
	public static void broadcastPageRank(Configuration conf, Path outdir)
			throws Exception {
